...
RUN chown vault:vault /home/vault/ca
RUN chown vault:vault /home/vault/config
RUN chown vault:vault /home/vault/scripts
RUN chown vault:vault /home/vault/plugins
